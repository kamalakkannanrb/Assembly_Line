        ...
        <div className="BottomBoxes grow">
            ...
            <div className="h-[80%] p-3 overflow-auto">
                ...
                <table className="w-full table-fixed">
                    ...
                    <tbody>
                        {master?.Parts && master.Parts.map((ele,index)=>{
                            return <tr key={index}>
